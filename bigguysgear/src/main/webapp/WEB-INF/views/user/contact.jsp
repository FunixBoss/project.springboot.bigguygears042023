				...
				<div id="map"
					...
					<div
						...
						<div class="gm-style"
							...
							<div tabindex="0"
								style="position: absolute; z-index: 0; left: 0px; top: 0px; height: 100%; width: 100%; padding: 0px; border-width: 0px; margin: 0px; cursor: url(_https_/maps.gstatic.com/mapfiles/openhand_8_8), default; touch-action: pan-x pan-y;">
								<div
			...
			<div class="row">
				...
				<div class="col-lg-8">
					<form class="form-contact contact_form"
						action="https://preview.colorlib.com/theme/shionhouse/contact_process.php"
						...
						<div class="media-body">
							<h3>
								<a
									...
									class="__cf_email__"
									data-cfemail="34474144445b464074575b585b46585d561a575b59">[email&#160;protected]</a>
							</h3>
