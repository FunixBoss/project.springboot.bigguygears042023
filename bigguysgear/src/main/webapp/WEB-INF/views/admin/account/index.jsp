                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name">
                        <a class="itemside" href="#">
                            <div class="left">
                                <img src="${pageContext.request.contextPath}/resources/admin/assets/imgs/items/1.jpg" class="img-sm img-thumbnail" alt="Item">
                            </div>
                            <div class="info">
            ...
            <article class="itemlist">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name">
                        <a class="itemside" href="#">
                            <div class="left">
                                <img src="${pageContext.request.contextPath}/resources/admin/assets/imgs/items/2.jpg" class="img-sm img-thumbnail" alt="Item">
                            </div>
                            <div class="info">
            ...
            <article class="itemlist">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name">
                        <a class="itemside" href="#">
                            <div class="left">
                                <img src="${pageContext.request.contextPath}/resources/admin/assets/imgs/items/3.jpg" class="img-sm img-thumbnail" alt="Item">
                            </div>
                            <div class="info">
            ...
            <article class="itemlist">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name">
                        <a class="itemside" href="#">
                            <div class="left">
                                <img src="${pageContext.request.contextPath}/resources/admin/assets/imgs/items/4.jpg" class="img-sm img-thumbnail" alt="Item">
                            </div>
                            <div class="info">
            ...
            <article class="itemlist">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name">
                        <a class="itemside" href="#">
                            <div class="left">
                                <img src="${pageContext.request.contextPath}/resources/admin/assets/imgs/items/5.jpg" class="img-sm img-thumbnail" alt="Item">
                            </div>
                            <div class="info">
            ...
            <article class="itemlist">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name">
                        <a class="itemside" href="#">
                            <div class="left">
                                <img src="${pageContext.request.contextPath}/resources/admin/assets/imgs/items/6.jpg" class="img-sm img-thumbnail" alt="Item">
                            </div>
                            <div class="info">
